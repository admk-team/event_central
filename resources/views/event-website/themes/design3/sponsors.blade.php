                                                    ...
                                                    <div class="modal-content py-3 px-4">
                                                        <div class="d-flex justify-content-center">
                                                            <img src="{{ $partner->exhibitor_logo }}"
                                                                alt="{{ $partner->type }}" style="height: 120px;">
                                                        </div>
                                                        <div class=" text-center">
                                                            ...
                                                            <p class="text-muted">{{ $partner->exhibitor_booth_no }}
                                                            </p>
                                                            @if ($partner->web)
                                                                ...
                                                                <a style="text-decoration: none; color:black"
                                                                    target="_blank" href="{{ $partner->twitter }}">
                                                            ...
                                                            <div class="description-container">
                                                                @if (strlen($partner->description) > 100)
                                                                    <p class="description-text short-description"
                                                                        ...
                                                                        {{ substr($partner->description, 0, 100) }}...
                                                                    </p>
                                                                    ...
                                                                    <button class="btn show-more-btn p-0"
                                                                        ...
                                                                        More</button>
                                                                @else
                                                                    <p class="text-muted">{{ $partner->description }}
                                                                    </p>
                                                                @endif
                                                            </div>
                                                        </div>
