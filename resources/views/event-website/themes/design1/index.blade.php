...
<section class="hero hero--band">
  <div class="container">
    <div class="hero-content hero-content--split">
      <!-- LEFT image column -->
      <div class="hero-graphics hero-graphics--left">
        <div class="hero-image hero-image--tall">
      ...
      <div class="hero-panel">
        <div class="event-meta event-meta--row">
          @php
          ...
          @else
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24">
              <path d="m18.707 12.707-3 3a1 1 0 0 1-1.414-1.414L15.586 13H6a1 1 0 0 1 0-2h9.586l-1.293-1.293a1 1 0 0 1 1.414-1.414l3 3a1 1 0 0 1 0 1.414z" style="fill:var(--_ink)" data-name="Right"/>
            </svg>
            <div class="event-date">
        ...
        <h1 class="event-title">
          {{ $event->name }}
          <span class="highlight">{{ date('Y', strtotime($event->dates[0]->date)) }}</span>
        </h1>
        ...
        <div class="hero-cta hero-cta--row">
          <a href="{{ route('attendee.register', $event) }}{{ ($isPreviewMode ?? false) || request('preview') == 'true' ? '?preview=true' : '' }}" class="btn btn-primary btn-lg">Secure Your Spot</a>
          <a href="{{ route('organizer.events.website.schedule', $event->uuid) }}{{ ($isPreviewMode ?? false) || request('preview') == 'true' ? '?preview=true' : '' }}" class="btn btn-outline btn-lg">Explore Schedule</a>
        </div>

        <!-- COUNTDOWN (IDs kept for your script) -->
        <div class="countdown countdown--card" id="countdown">
  ...
  <!-- STATS -->
  <div class="hero-stats hero-stats--inband">
    <div class="container">
...
<section id="about" class="about about--mosaic">
  <div class="container">
    <div class="section-header">
      <span class="section-tag">About the Event</span>
      <h2 class="section-title">{{ $event->name }}</h2>
    </div>
    <div class="about-content about-content--mosaic">
      <div class="about-text">{!! $event->description !!}</div>
      <div class="about-video">
        <div class="video-wrapper video-wrapper--card">
...
<section id="venue" class="venue venue--centered">
  <div class="container">
    <div class="section-header">
      ...
      @foreach ($event->tickets ?? [] as $ticket)
        @if ($ticket->show_on_attendee_side)
          <div class="pricing-card d-flex flex-column h-100">
            ...
            <a href="{{ route('attendee.register', $event) }}{{ ($isPreviewMode ?? false) || request('preview') == 'true' ? '?preview=true' : '' }}" class="btn btn-primary btn-block mt-auto">Register Now</a>
          </div>
        @endif
      @endforeach
