                ...
                <Dropdown
                    ...
                    <Dropdown.Toggle as="button" type="button" className="arrow-none btn">
                        <span className="d-flex align-items-center">
                            <img className="rounded-circle header-profile-user" src={user.avatar_img ? user.avatar_img : avatar1}
                                alt="Header Avatar" />
                            <span className="text-start ms-xl-2">
                                <span className="d-none d-xl-inline-block ms-1 fw-medium user-name-text" style={{ textTransform: 'capitalize' }}>{user?.first_name}</span>
                    ...
                    <Dropdown.Menu className="dropdown-menu-end">
                        ...
                        <Link className="dropdown-item" as="button" method="post" href={route('attendee.logout', [eventApp.id])}><i
