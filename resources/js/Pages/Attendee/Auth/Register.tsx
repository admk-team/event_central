...
export default function Register() {
    ...
    const closeRegister: any = usePage().props.closeRegistration;
                            ...
                            <div className="card text-center shadow-sm border-danger">
                                <div className="card-body py-5">
                                    ...
                                    <p className="text-muted">
                                        We’re sorry, but registration for this event is now closed. Please contact the event organizer if you have any questions or need further assistance.
                                    </p>
                                </div>
                            </div>
                        </div>
