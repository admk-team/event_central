            ...
            <Col xl={6}>
                <Card>
                    <Card.Header className="border-0 align-items-center d-flex">
                        <h4 className="card-title mb-0 flex-grow-1">{t('Audiences Metrics')}</h4>
                        ...
                        <Row className="g-0 text-center">
                            <Col xs={6} sm={4}>
                                <div className="p-3 border border-dashed border-start-0">
                                    ...
                                    <p className="text-muted mb-0">{t('Avg. Session')}</p>
                                </div>
                            </Col>
                            <Col xs={6} sm={4}>
                                <div className="p-3 border border-dashed border-start-0">
                                    ...
                                    <p className="text-muted mb-0">{t('Conversion Rate')}</p>
                                </div>
                            </Col>
                            <Col xs={6} sm={4}>
                                <div className="p-3 border border-dashed border-start-0 border-end-0">
                                    <h5 className="mb-1">
                                        <CountUp start={0} end={3} duration={3} />m <CountUp start={0} end={40} duration={3} />sec
                                        <span className="text-success ms-1 fs-12">37%<i className="ri-arrow-right-up-line ms-1 align-middle"></i></span>
                                    </h5>
                                    <p className="text-muted mb-0">{t('Avg. Session Duration')}</p>
                                </div>
                            </Col>
                        </Row>
                    </Card.Header>
