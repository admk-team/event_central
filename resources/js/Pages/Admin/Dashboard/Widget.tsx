                    ...
                    <Card className="card-animate">
                        <Card.Body>
                            <div className="d-flex justify-content-between">
                                <div>
                                    <p className="fw-medium text-muted mb-0">{t("users")}</p>
                                    <h2 className="mt-4 ff-secondary fw-semibold">
                                        <span className="counter-value">
                                            <CountUp start={0} end={28.05} decimals={1} duration={4} />
                                        </span>k
                                    </h2>
                ...
                <Col md={6}>
                    <Card className="card-animate">
                        <Card.Body>
                            <div className="d-flex justify-content-between">
                                <div>
                                    <p className="fw-medium text-muted mb-0">{t("sessions")}</p>
                                    <h2 className="fs-22 mt-4 ff-secondary fw-semibold">
                                        <span className="counter-value">
                                            <CountUp start={0} end={97.66} decimals={2} duration={4} />
                                        </span>k
                                    </h2>
                                    <p className="mb-0 text-muted text-truncate">
                ...
                <Col md={6}>
                    <Card className="card-animate">
                        <Card.Body>
                            <div className="d-flex justify-content-between">
                                <div>
                                    <p className="fw-medium text-muted mb-0">{t("avg_visit_duration")}</p>
                                    <h2 className="fs-22 mt-4 ff-secondary fw-semibold">
                                        <span className="counter-value"><CountUp start={0} end={3} duration={4} /></span> {t("min")}{" "}
                                        <span className="counter-value"><CountUp start={0} end={40} duration={4} /></span> {t("sec")}
                                    </h2>
                                    <p className="mb-0 text-muted text-truncate">
                                        <span className="badge bg-light text-danger mb-0">
                ...
                <Col md={6}>
                    <Card className="card-animate">
                        <Card.Body>
                            <div className="d-flex justify-content-between">
                                <div>
                                    <p className="fw-medium text-muted mb-0">{t("bounce_rate")}</p>
                                    <h2 className="fs-22 mt-4 ff-secondary fw-semibold">
                                        <span className="counter-value"><CountUp start={0} end={33.48} decimals={2} duration={4} /></span>%
                                    </h2>
                                    <p className="mb-0 text-muted text-truncate">
                                        <span className="badge bg-light text-success mb-0">
