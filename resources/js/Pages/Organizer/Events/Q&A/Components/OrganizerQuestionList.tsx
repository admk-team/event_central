    ...
    <div className="space-y-4">
      {sortedQuestions.length === 0 ? (
        <Card className="text-center p-4">
          <p className="text-muted mb-0">{t("No questions have been submitted yet.")}</p>
        </Card>
      ) : (
                ...
                <Col>
                  ...
                  <p className="text-muted fs-12 mb-0">
                    ...
                    <Badge bg="light" text="dark">
                      {question.user?.name || question.user?.first_name || t("Anonymous")}
                    </Badge>{" "}
                        ...
                        <Row className="align-items-center">
                          <Col>
                            ...
                            <p className="text-muted fs-12 mt-1">
                              {t("Answered by")}{" "}
                              <Badge bg="light" text="dark">
                                {answer.user?.name || answer.user?.first_name || t("Anonymous")}
                              </Badge>{" "}
