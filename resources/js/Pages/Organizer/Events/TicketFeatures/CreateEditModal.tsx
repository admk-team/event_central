...
export default function CreateEditModal({ show, hide, onHide, feature }:
                    ...
                    <Row>
                        ...
                        <Col md={4}>
                            <FormGroup className="mb-3">
                                ...
                                />
                                {errors.qty_total && <Form.Control.Feedback type="invalid">{errors.qty_total}</Form.Control.Feedback>}
                            </FormGroup>
                        </Col>
                        ...
                        <Col md={4}>
                            <FormGroup className="mb-3">
                                ...
                                <Form.Control
                                    ...
                                    disabled
                                    value={data.qty_sold}
                                    onChange={(e) => setData('qty_sold', e.target.value)}
                                    isInvalid={!!errors.qty_sold}
                                />
                                {errors.qty_sold && <Form.Control.Feedback type="invalid">{errors.qty_sold}</Form.Control.Feedback>}
                            </FormGroup>
                        </Col>
                    </Row>
                </Form>
