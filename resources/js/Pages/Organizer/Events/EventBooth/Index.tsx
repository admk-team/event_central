...
function Index({ data, attendees }: { data: any; attendees: Attendee[] }) {
    ...
    const editAction = (booth: any) => {
        ...
        const selectedIds = (booth.attendees_badges || []).map(
            (a: any) => a.id
        );
    ...
    const columns: ColumnDef<(typeof data.data)[0]> = [
        ...
        },
        {
            ...
            header: () => t("Attendees"),
            cell: (row: any) => {
                const list = (row.attendees_badges || []) as {
                    id: number;
                    name: string;
                    email: string;
                }[];
        ...
        },
        {
            ...
            cell: (row) => (
                <div className="hstack gap-3 fs-15">
                    <a
                        href={route("organizer.booth-purchases.booth", row.id)}
