...
export default function CreateEditModal({ show, hide, onHide, eventSession, eventPlatformId }: { show: boolean, hide: () => void, onHide: () => void, eventSession: any, eventPlatformId: any }) {
    ...
    const { data, setData, post, put, processing, errors, reset } = useForm({
        ...
        event_platform_id: eventSession?.event_platform_id ?? eventPlatformId,
        type: eventSession?.type ?? 'Lecture',
        description: eventSession?.description ?? '',
        capacity: eventSession?.capacity ?? '',
        start_date: eventSession?.start_date ?? '',
        end_date: eventSession?.end_date ?? '',
        event_app_id: eventSession?.event_app_id ?? '',
    });
